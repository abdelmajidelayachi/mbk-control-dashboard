...
public class UpdateMessage implements Serializable {
    ...
    @ApiModelProperty(position = 2, value = "Current Mbk Controls version.")
    private final String currentVersion;
    @ApiModelProperty(position = 3, value = "Latest Mbk Controls version.")
    private final String latestVersion;
    @ApiModelProperty(position = 4, value = "Upgrade instructions URL.")
    private final String upgradeInstructionsUrl;
    @ApiModelProperty(position = 5, value = "Current Mbk Controls version release notes URL.")
    private final String currentVersionReleaseNotesUrl;
    @ApiModelProperty(position = 6, value = "Latest Mbk Controls version release notes URL.")
